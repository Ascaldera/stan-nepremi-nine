...
class ExtendContacts(models.Model):
    ...
    kupec_najemnik_nepremicnina_vrsta = fields.Selection(string = 'Vrsta nepremičnine', selection = [('stanovanje', 'Stanovanje'), 
                                                                                      ('hisa', 'Hiša'), 
                                                                                      ...
                                                                                      ('garaza', 'Garaža'), 
                                                                                      ('drugo', 'Drugo'),])
    kupec_najemnik_nepremicnina_vrsta_drugo = fields.Char(string = 'Druga vrsta')
    kupec_najemnik_nepremicnina_tip=fields.Selection(string="Tip nepremičnine", selection=[('apartma','Apartma'),
                                                                                  ('soba','Soba'),
                                                                                  ...
                                                                                  ('drugo','Drugo')])
    kupec_najemnik_nepremicnina_tip_1 = fields.Selection(string = 'Tip nepremičnine 1', selection=[('apartma','Apartma'),
                                                                                  ('soba','Soba'),
                                                                                  ('garsonjera', 'Garsonjera'),
                                                                                  ('soba1','1-sobno'),
                                                                                  ('soba1_5', '1,5-sobno'),
    ...
    kupec_najemnik_nepremicnina_tip_2 = fields.Selection(string = 'Tip nepremičnine 2', selection=[('atrij','Atrij'),
                                                                                  ('dvojcek','Dvojcek'),
                                                                                  ('samostojna','Samostojna'),
                                                                                  ('drugo','Drugo')])
    
    kupec_najemnik_nepremicnina_tip_3 = fields.Selection(string = 'Tip nepremičnine 3', selection=[('delavnica','Delavnica'),
                                                                                  ('gostinskiLokal','Gostinski lokal'),
                                                                                  ('pisarna','Pisarna'),
                                                                                  ('prostorZaStoritve','Prostor za storitve'),
                                                                                  ('skladisce','Skladišče'),
    ...
    @api.onchange('kupec_najemnik_nepremicnina_vrsta','kupec_najemnik_nepremicnina_tip_1','kupec_najemnik_nepremicnina_tip_2','kupec_najemnik_nepremicnina_tip_3')
    def prepis_vrednosti(self):
        if self.kupec_najemnik_nepremicnina_vrsta=='stanovanje':
            self.kupec_najemnik_nepremicnina_tip_2=[]
            self.kupec_najemnik_nepremicnina_tip_3=[]
            if self.kupec_najemnik_nepremicnina_tip_1==False:
                self.kupec_najemnik_nepremicnina_tip=[]
        if self.kupec_najemnik_nepremicnina_vrsta=='hisa':
            self.kupec_najemnik_nepremicnina_tip_1=[]
            self.kupec_najemnik_nepremicnina_tip_3=[]
            if self.kupec_najemnik_nepremicnina_tip_2==False:
                self.kupec_najemnik_nepremicnina_tip=[]
        if self.kupec_najemnik_nepremicnina_vrsta=='poslovni':
            self.kupec_najemnik_nepremicnina_tip_1=[]
            self.kupec_najemnik_nepremicnina_tip_2=[]
            if self.kupec_najemnik_nepremicnina_tip_3==False:
                self.kupec_najemnik_nepremicnina_tip=[]
        if self.kupec_najemnik_nepremicnina_vrsta not in ['stanovanje','hisa','poslovni']:
            self.kupec_najemnik_nepremicnina_tip=[]
            self.kupec_najemnik_nepremicnina_tip_1=[]
            self.kupec_najemnik_nepremicnina_tip_2=[]
            self.kupec_najemnik_nepremicnina_tip_3=[]
        if self.kupec_najemnik_nepremicnina_vrsta != 'hisa':
            self.kupec_najemnik_nepremicnina_etaza = ""
        if self.kupec_najemnik_nepremicnina_vrsta not in ['stanovanje', 'poslovni']:              
            self.kupec_najemnik_nepremicnina_nadstropje = 0
            self.kupec_najemnik_nepremicnina_st_nadstropij = 0
        if self.kupec_najemnik_nepremicnina_tip_1:
            self.kupec_najemnik_nepremicnina_tip=self.kupec_najemnik_nepremicnina_tip_1
        if self.kupec_najemnik_nepremicnina_tip_2:
            self.kupec_najemnik_nepremicnina_tip=self.kupec_najemnik_nepremicnina_tip_2
        if self.kupec_najemnik_nepremicnina_tip_3:
            self.kupec_najemnik_nepremicnina_tip=self.kupec_najemnik_nepremicnina_tip_3
    
    
    kupec_najemnik_nepremicnina_regija=fields.Selection(string ="Regija",
                                         selection=[('dolenjska','Dolenjska'),
                                                    ...
                                                    ('savinjska','Savinjska'),
                                                    ('zasavska','Zasavska')])
    kupec_najemnik_nepremicnina_upravna_enota=fields.Selection(string="Upravna enota",
    ...
    kupec_najemnik_nepremicnina_upravne_enote_1=fields.Selection(string="Upravna_enota_dolenjska", 
                                                  selection=[('crnomelj','Črnomelj'),
                                                             ('kocevje','Kočevje'),
                                                             ('metlika','Metlika'),
                                                             ('novo_mesto','Novo mesto'),
                                                             ('ribnica','Ribnica'),
                                                             ('trebnje','Trebnje')])
    kupec_najemnik_nepremicnina_upravne_enote_2=fields.Selection(string="Upravna_enota_gorenjska", 
                                                  selection=[('jesenice','Jesenice'),
                                                             ('kranj','Kranj'),
                                                             ('radovljica','Radovljica'),
                                                             ('skofja_loka','Škofja loka'),
                                                             ('trzic','Tržič')])
    kupec_najemnik_nepremicnina_upravne_enote_3=fields.Selection(string="Upravna_enota_juzna_primorska", 
                                                  selection=[('izola','Izola'),
                                                             ('koper','Koper'),
                                                             ('piran','Piran'),
                                                             ('sezana','Sežana')])
    kupec_najemnik_nepremicnina_upravne_enote_4=fields.Selection(string="Upravna_enota_severna_primorska", 
                                                  selection=[('ajdovscina','Ajdovščina'),
                                                             ('idrija','Idrija'),
                                                             ('nova_gorica','Nova Gorica'),
                                                             ('tolmin','Tolmin')])
    kupec_najemnik_nepremicnina_upravne_enote_5=fields.Selection(string="Upravna_enota_koroska", 
                                                  selection=[('dravograd','Dravograd'),
                                                             ('radlje_ob_dravi','Radlje ob Dravi'),
                                                             ('ravne_na_koroskem','Ravne na Koroškem'),
                                                             ('slovenj_gradec','Slovenj Gradec')])
    kupec_najemnik_nepremicnina_upravne_enote_6=fields.Selection(string="Upravna_enota_lj_mesto", 
                                                  selection=[('bezigrad','Lj. Bežigrad'),
                                                             ('center','Lj. Center'),
                                                             ('moste_polje','Lj. Moste-Polje'),
                                                             ('siska','Lj. Šiška'),
                                                             ('vic_rudnik','Lj. Vič-Rudnik')])
    kupec_najemnik_nepremicnina_upravne_enote_7=fields.Selection(string="Upravna_enota_lj_okolica", 
                                                  selection=[('domzale','Domžale'),
                                                             ...
                                                             ('logatec','Logatec'),
                                                             ('vrhnika','Vrhnika')])
    kupec_najemnik_nepremicnina_upravne_enote_8=fields.Selection(string="Upravna_enota_notranjska", 
                                                  selection=[('cerknica','Cerknica'),
                                                             ('ilirska_bistrica','Ilirska Bistrica'),
                                                             ('postojna','Postojna')])
    kupec_najemnik_nepremicnina_upravne_enote_9=fields.Selection(string="Upravna_enota_podravska", 
                                                  selection=[('lenart','Lenart'),
                                                             ...
                                                             ('ruse','Ruše'),
                                                             ('slovenska_bistrica','Slovenska bistrica')])
    kupec_najemnik_nepremicnina_upravne_enote_10=fields.Selection(string="Upravna_enota_pomurska", 
                                                   selection=[('gornja_radgona','Gornja Radgona'),
                                                              ('lendava','Lendava'),
                                                              ('ljutomer','Ljutomer'),
                                                              ('murska_sobota','Murska Sobota')])
    kupec_najemnik_nepremicnina_upravne_enote_11=fields.Selection(string="Upravna_enota_posavska", 
                                                   selection=[('brezice','Brežice'),
                                                              ('krsko','Krško'),
                                                              ('sevnica','Sevnica')])
    kupec_najemnik_nepremicnina_upravne_enote_12=fields.Selection(string="Upravna_enota_savinjska", 
                                                   selection=[('celje','Celje'),
                                                              ...
                                                              ('velenje','Velenje'),
                                                              ('zalec','Žalec')])
    kupec_najemnik_nepremicnina_upravne_enote_13=fields.Selection(string="Upravna_enota_zasavska", 
                                                   selection=[('hrastnik','Hrastnik'),
                                                              ('trbovlje','Trbovlje'),
                                                              ('zagorje_ob_savi','Zagorje ob Savi')])

    
    @api.onchange('kupec_najemnik_nepremicnina_regija','kupec_najemnik_nepremicnina_upravna_enota','kupec_najemnik_nepremicnina_upravne_enote_1','kupec_najemnik_nepremicnina_upravne_enote_2','kupec_najemnik_nepremicnina_upravne_enote_3','kupec_najemnik_nepremicnina_upravne_enote_4','kupec_najemnik_nepremicnina_upravne_enote_5','kupec_najemnik_nepremicnina_upravne_enote_6','kupec_najemnik_nepremicnina_upravne_enote_7','kupec_najemnik_nepremicnina_upravne_enote_8','kupec_najemnik_nepremicnina_upravne_enote_9','kupec_najemnik_nepremicnina_upravne_enote_10','kupec_najemnik_nepremicnina_upravne_enote_11','kupec_najemnik_nepremicnina_upravne_enote_12','kupec_najemnik_nepremicnina_upravne_enote_13',)
    def upravna_enota_selection(self):
        if self.kupec_najemnik_nepremicnina_regija=="dolenjska":
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_5=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_6=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_7=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_8=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_9=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_10=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_11=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_1==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="gorenjska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_5=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_6=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_2==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="juzna_primorska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_5=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_3==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="severna_primorska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_5=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_4==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="koroska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_5==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="lj_mesto":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_6==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="lj_okolica":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_7==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="notranjska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_8==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="podravska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_9==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="pomurska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_10==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="posavska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_11==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="savinjska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_11=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_13=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_12==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_regija=="zasavska":
            self.kupec_najemnik_nepremicnina_upravne_enote_1=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_2=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_3=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_4=[]
            ...
            self.kupec_najemnik_nepremicnina_upravne_enote_11=[]
            self.kupec_najemnik_nepremicnina_upravne_enote_12=[]
            if self.kupec_najemnik_nepremicnina_upravne_enote_13==False:
                self.kupec_najemnik_nepremicnina_upravna_enota=[]
        if self.kupec_najemnik_nepremicnina_upravne_enote_1:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_1
        if self.kupec_najemnik_nepremicnina_upravne_enote_2:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_2
        if self.kupec_najemnik_nepremicnina_upravne_enote_3:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_3
        if self.kupec_najemnik_nepremicnina_upravne_enote_4:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_4
        if self.kupec_najemnik_nepremicnina_upravne_enote_5:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_5
        if self.kupec_najemnik_nepremicnina_upravne_enote_6:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_6
        if self.kupec_najemnik_nepremicnina_upravne_enote_7:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_7
        if self.kupec_najemnik_nepremicnina_upravne_enote_8:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_8
        if self.kupec_najemnik_nepremicnina_upravne_enote_9:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_9
        if self.kupec_najemnik_nepremicnina_upravne_enote_10:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_10
        if self.kupec_najemnik_nepremicnina_upravne_enote_11:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_11
        if self.kupec_najemnik_nepremicnina_upravne_enote_12:
            self.kupec_najemnik_nepremicnina_upravna_enota=self.kupec_najemnik_nepremicnina_upravne_enote_12
